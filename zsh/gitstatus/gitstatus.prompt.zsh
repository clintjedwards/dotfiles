...
function gitstatus_prompt_update() {
  ...
  # Use spectrum_ls to view your system colors
  # The first 16 or so numbers are your default system colors
  # This is helpful if you have custom terminal colors you like
